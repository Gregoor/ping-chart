...
/***/ function(module, exports, __webpack_require__) {
	...
	svg.append('g').attr({ 'class': 'x axis', 'transform': 'translate(0, ' + height + ')' }).append('line').attr({ x1: 0, y1: 0, x2: width, y2: 0 });

	var yAxisGroup = svg.append('g').attr('class', 'y axis').call(yAxis);

	yAxisGroup.append('text').attr({ transform: 'rotate(-90)', y: 6, dy: '.71em' }).style('text-anchor', 'end').text('Ping (ms)');

	var path = svg.append('path').attr('class', 'line');

	var draw = function draw(data) {
	  var pointWidth = width / (data.length - 1);
	  ...
	  if (isRunning) {
	    (function () {
	      ...
	      intervalID = setInterval(function () {
	        return (0, _ping2.default)(url).then(function (delta) {
...
/***/ function(module, exports) {
	 ...
	 *                   fails to an Error.
	 */
	var request_image = function request_image(url) {
	 ...
	 */
	var ping = function ping(url, multiplier) {
	  return new Promise(function (resolve, reject) {
